...
RESOURCES += src/qt/KALMEX.qrc src/qt/KALMEX_locale.qrc

TRANSLATIONS += src/qt/locale/KALMEX_bg.ts \
                src/qt/locale/KALMEX_de.ts \
                src/qt/locale/KALMEX_en.ts \
                src/qt/locale/KALMEX_es.ts \
                src/qt/locale/KALMEX_fi.ts \
                src/qt/locale/KALMEX_fr.ts \
                src/qt/locale/KALMEX_it.ts \
                src/qt/locale/KALMEX_ja.ts \
                src/qt/locale/KALMEX_pl.ts \
                src/qt/locale/KALMEX_pt.ts \
                src/qt/locale/KALMEX_ru.ts \
                src/qt/locale/KALMEX_sk.ts \
                src/qt/locale/KALMEX_sv.ts \
                src/qt/locale/KALMEX_vi.ts \
                src/qt/locale/KALMEX_zh_CN.ts \
                src/qt/locale/KALMEX_zh_TW.ts
