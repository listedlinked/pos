...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KALMEX Core KALMEX-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  KALMEX-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded KALMEX transaction") + "\n" +
                               "  KALMEX-tx [options] -create [commands]   " + _("Create hex-encoded KALMEX transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded KALMEX transaction
