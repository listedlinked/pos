...
/** Utility functions used by the KALMEX Qt UI.
 */
namespace GUIUtil
{
...
// Render KALMEX addresses in monospace font
...
// Parse "KALMEX:" URI into recipient object, return true on successful parsing
