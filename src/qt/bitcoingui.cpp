                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("KALMEX-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KALMEX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and KALMEX: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KALMEX Core"), this);
    aboutAction->setStatusTip(tr("Show information about KALMEX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KALMEX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KALMEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KALMEX addresses"));
    ...
    openAction->setStatusTip(tr("Open a KALMEX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KALMEX Core help message to get a list with possible KALMEX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KALMEX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KALMEX network", "", count));
}
...
{
    QString strTitle = tr("KALMEX Core"); // default title
