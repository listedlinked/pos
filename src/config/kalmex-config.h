/* src/config/KALMEX-config.h.  Generated from KALMEX-config.h.in by configure.  */
/* src/config/KALMEX-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef KALMEX_CONFIG_H

#define KALMEX_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://KALMEX.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "KALMEX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "KALMEX Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "KALMEX"
